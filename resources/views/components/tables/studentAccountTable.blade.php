            ...
            <div class="modal-body">
                <form id="app" novalidate="true">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" id="email" name="email" class="form-control mt-2" v-model="editingStudentAccount.email" >
                    </div>
                </form>
            </div>
    ...
    const App = new Vue({
        ...
        methods: {
            checkFirstName(firstName){
                if (!firstName) {
                    this.errors.push('Không được để trống họ và tên đệm.');
                    return false;
                }

                if (!this.validName(firstName)) {
                    this.errors.push('Định dạng họ và tên đệm không chính xác.');
                    return false;
                }
                return true;
            },
            checkLastName(lastName){
                if (!lastName) {
                    this.errors.push('không được để trống tên.');
                    return false;
                }

                if (!this.validName(lastName)) {
                    this.errors.push('Định dạng tên không chính xác.');
                    return false;
                }
                return true;
            },
            checkEmail(email){
                ...
                if (!this.validEmail(email)) {
                    this.errors.push('Định dạng email không chính xác.');
                    return false;
                }
                return true;
            },
            ...
            editStudentAccount(studentAccountId) {
                this.errors = [];
                // let success = true;
                let firstName = this.editingStudentAccount.first_name;
                let lastName = this.editingStudentAccount.last_name;
                let email = this.editingStudentAccount.email;

                
                if(!this.checkFirstName(firstName) | !this.checkLastName(lastName) | !this.checkEmail(email) == true){
                    console.log("fail");
                } else {
